...
$validlevels['U15'] = ['Club', 'State', 'National', 'International'];
$validlevels['U17'] = ['Club', 'State', 'National', 'International'];
$validlevels['U20'] = ['Club', 'State', 'National', 'International'];
$validlevels['U23'] = ['Club', 'State', 'National', 'International'];
$validlevels['Open'] = ['Club', 'State', 'National', 'International'];
$validlevels['Veteran'] = ['Club', 'State', 'National', 'International'];
...
// This is to get the index into the points arrays below.  Done this way
// as I've had a brain fade and can't think of a mathematical expression
